                ...
                <div class="card mb-4 mt-4">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <form name="form1" method="post" action="update_product.php"
                                        ...
                                        <input type="text" name="proid" class="form-control" readonly
                                            value="<?php echo $rs['pro_id']?>">
                                        <label> ชื่อสินค้า</label>
                                        <input type="text" name="pname" class="form-control"
                                            value="<?php echo $rs['pro_name']?>">
                   ...
                   ?>
                                            <option value="<?=$row['type_id']?>"
                                                <?php if($p_typeID==$ttype_id){echo "selected=selected";} ?>>
                    ...
                    ?>
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                id="product_best" name="product_best"
                                                <?php if($rs['product_best'] == '1'){ echo "checked"; }?>>
                                        </div>
                                        <label> จำนวน </label>
                                        <input type="number" name="num" class="form-control"
                                            value="<?php echo $rs['amount']?>"> <br>
