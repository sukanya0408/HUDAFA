                    ...
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <a href="report_order_yes.php"> <button type="button"
                                    class="btn btn-outline-primary">ชำระเงินแล้ว</button> </a>
                            <a href="report_order.php"> <button type="button"
                                    class="btn btn-outline-primary">ยังไม่ชำระเงิน</button> </a>
                            <a href="report_order_no.php"> <button type="button"
                                    class="btn btn-outline-primary">ยกเลิกใบสั่งซื้อ</button> </a>
                            <a href="trans_yes.php"> <button type="button"
                                    class="btn btn-outline-primary">จัดส่งแล้ว</button> </a>
                        </div>
                    </div>
                    <br>
                    <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <a href="pay_order.php?id=<?=$row['orderID']?>" class="btn btn-info"
                                            onclick="del1(this.href); return false;">ปรับสถานะ</a>
                                        <a href="cancel_order.php?id=<?=$row['orderID']?>" class="btn btn-danger"
